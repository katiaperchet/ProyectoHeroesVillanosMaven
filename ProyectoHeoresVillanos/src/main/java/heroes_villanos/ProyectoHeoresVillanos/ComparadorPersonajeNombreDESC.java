 ...
 *ordenar descendentemente los personajes a través de la comparación de los nombres
 */
public class ComparadorPersonajeNombreDESC implements Comparator<Personaje> {
	...
	public int compare(Personaje o1, Personaje o2) {
			if(o1.getNombreFicticio().compareTo(o2.getNombreFicticio())==0)
			{
				...
				else if(comparacion==0)
				{
					...
					return comparacionVelocidad*-1;
				}
			}
			return o1.getNombreFicticio().compareTo(o2.getNombreFicticio())*-1;	
