 ...
 *ordenar ascendentemente los personajes a través de la comparación de la velocidad
 */
public class ComparadorPersonajeVelocidadASC implements Comparator<Personaje> {
	...
	public int compare(Personaje o1, Personaje o2) {
			...
			return Integer.compare(valorvelocidad1, valorvelocidad2);	
