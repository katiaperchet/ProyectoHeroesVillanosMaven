 ...
 *ordenar ascendentemente los personajes a través de la comparación de la fuerza
 */
public class ComparadorPersonajeFuerzaASC implements Comparator<Personaje> {
	...
	public int compare(Personaje o1, Personaje o2) {
		...
		return Integer.compare(valorfuerza1, valorfuerza2);
	}
